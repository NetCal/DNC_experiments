...
public class CacheTest {
	...
	public static void main(String[] args) {
		try {
			String dir = System.getProperty("user.dir") + "/src/experiments/cachetest2019results/";
			dir = dir.trim();
	...
	public CacheTest(String input_output_path, int num_net_devices) throws Exception {
...
//		tma_config.setConvolveAlternativeArrivalBounds( false );
//		tma_config.setUseArrivalBoundsCache( false );
//		TandemMatchingAnalysis tma = new TandemMatchingAnalysis( server_graph, tma_config );
...
//
//			delay_pw.print(tma.getDelayBound().toString());
//			delay_pw.print(", ");
//			delay_pw.flush();
//
...
//			execT_pw.flush();
			...
			// TMA_conv_cache
			t_start_solving = System.nanoTime();
			tma_conv_cache.performAnalysis(flow_of_interest);
			t_stop_solving = System.nanoTime();

			delay_pw.print(tma_conv_cache.getDelayBound().toString());
			delay_pw.print(", ");
			delay_pw.flush();
