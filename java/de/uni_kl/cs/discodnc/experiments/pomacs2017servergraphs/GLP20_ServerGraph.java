...
public class GLP20_ServerGraph{
	...
	public static void createLinks1() throws Exception {
		server_graph.addLink( "l19", servers[14], servers[0] );
		server_graph.addLink( "l13", servers[11], servers[28] );
		server_graph.addLink( "l26", servers[9], servers[3] );
		server_graph.addLink( "l9", servers[25], servers[12] );
		server_graph.addLink( "l23", servers[3], servers[31] );
		server_graph.addLink( "l10", servers[13], servers[22] );
		server_graph.addLink( "l18", servers[16], servers[21] );
		server_graph.addLink( "l45", servers[31], servers[23] );
		server_graph.addLink( "l11", servers[13], servers[23] );
		server_graph.addLink( "l39", servers[29], servers[35] );
		server_graph.addLink( "l51", servers[36], servers[9] );
		server_graph.addLink( "l7", servers[21], servers[8] );
		server_graph.addLink( "l40", servers[29], servers[36] );
		server_graph.addLink( "l27", servers[4], servers[6] );
		server_graph.addLink( "l30", servers[19], servers[1] );
		server_graph.addLink( "l24", servers[3], servers[33] );
		server_graph.addLink( "l50", servers[36], servers[7] );
		server_graph.addLink( "l35", servers[18], servers[25] );
		server_graph.addLink( "l36", servers[10], servers[29] );
		server_graph.addLink( "l4", servers[7], servers[19] );
		server_graph.addLink( "l8", servers[21], servers[9] );
		server_graph.addLink( "l14", servers[2], servers[22] );
		server_graph.addLink( "l52", servers[28], servers[14] );
		server_graph.addLink( "l33", servers[18], servers[23] );
		server_graph.addLink( "l5", servers[7], servers[20] );
		server_graph.addLink( "l22", servers[37], servers[36] );
		server_graph.addLink( "l53", servers[15], servers[27] );
		server_graph.addLink( "l28", servers[4], servers[7] );
		server_graph.addLink( "l46", servers[31], servers[25] );
		server_graph.addLink( "l3", servers[5], servers[13] );
		server_graph.addLink( "l16", servers[2], servers[25] );
		server_graph.addLink( "l44", servers[31], servers[22] );
		server_graph.addLink( "l32", servers[0], servers[21] );
		server_graph.addLink( "l42", servers[24], servers[32] );
		server_graph.addLink( "l29", servers[4], servers[8] );
		server_graph.addLink( "l2", servers[17], servers[9] );
		server_graph.addLink( "l41", servers[34], servers[30] );
		server_graph.addLink( "l6", servers[21], servers[6] );
		server_graph.addLink( "l20", servers[1], servers[15] );
		server_graph.addLink( "l43", servers[24], servers[33] );
		server_graph.addLink( "l12", servers[13], servers[24] );
		server_graph.addLink( "l0", servers[17], servers[7] );
		server_graph.addLink( "l48", servers[8], servers[35] );
		server_graph.addLink( "l15", servers[2], servers[24] );
		server_graph.addLink( "l38", servers[26], servers[32] );
		server_graph.addLink( "l25", servers[32], servers[4] );
		server_graph.addLink( "l47", servers[8], servers[34] );
		server_graph.addLink( "l21", servers[37], servers[34] );
		server_graph.addLink( "l34", servers[18], servers[24] );
		server_graph.addLink( "l37", servers[26], servers[31] );
		server_graph.addLink( "l49", servers[36], servers[6] );
		server_graph.addLink( "l17", servers[16], servers[19] );
		server_graph.addLink( "l1", servers[17], servers[8] );
		server_graph.addLink( "l31", servers[0], servers[20] );
	}
